...
const TrafficData = [
  {
    ...
    Disadvantages:
      "Fewer trains at weekends, inaccurate evening times, strikes can affect operations.",
  },
  {
    id: "T2",
    Title: "Tram",
    ...
    Disadvantages:
      "Fewer routs. Fewer trains at weekends, inaccurate evening times, strikes can affect operations.",
  },
  {
    id: "T3",
    Title: "City-bike",
    ...
    Disadvantages:
      "Only 45 minutes to unlock each time and must be returned to the designated location.",
  },
];
